...
public class Main extends javax.swing.JFrame implements WindowListener {
    ...
    void decodeASN1(byte[] encodedData, JEditorPane asn1Pane) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(Decoder.this, e.toString(), "Connection Error", JOptionPane.ERROR_MESSAGE);
    ...
    boolean loadFile(JFrame frame, JEditorPane asn1Pane) {
        try {
            ...
            int userSelection = fileChooser.showOpenDialog(Decoder.this);
            ...
            JOptionPane.showMessageDialog(Decoder.this, ex.toString(), "Connection Error", JOptionPane.ERROR_MESSAGE);
    ...
    public Decoder(String title) {
        ...
        loadButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                loadFile(Decoder.this, Decoder.this.asn1Pane);
    ...
    public void windowOpened(WindowEvent e) {
        ...
        if (!loadFile(Decoder.this, Decoder.this.asn1Pane)) {
            e.getWindow().setVisible(false);
            System.exit(0);
        }
